...
foreach ($chat in ($ChatEventsCount.GetEnumerator()| Sort key)){
    ...
    $EventsGroups = Parse-Chat -EventRows $EventRows -FieldNameCols $FieldNameCol -AttachmentCols $AttachmentCols -CustodianID $CustodianID -GroupBy $GroupMessagesBy -MaxMessagesPerChat 9999 -ProgressHelper ([ref] $global:Helper)
